    ...
    while True:
        ...
        if NN is None:
            ...
            if WALLS >= 2:
                ...
                plural = ''
            msg += 'IA pour plateau ' + str(N) + 'x' + str(N) + ' avec ' + str(
                WALLS) + ' mur' + plural + ' par joueur, '
        ...
        msg += '\nUtilisation : \n'
        L = [['new 5 1 40',
              '# crée une nouvelle IA pour un plateau 5x5 avec 1 mur par joueur, avec 40 neurones sur la couche interne'],
             ...
             ['compare nomfichier.npz 1000 0.05',
              "# tournoi entre l'IA et celle du fichier nomfichier.npz sur 1000 parties avec eps=0.05 pour les 2 IAs"],
        ...
        if len(L) > 0:
            if L[0] == 'new' and len(L) == 4:
                ...
                if NN is None:
                    ...
                    agent = Player_AI(NN, 0.0, None,
                                      'IA')  # IA joue le mieux possible
                    play(human, agent)
